...
export const generarCodigoEstudiante = async () => {
    try {
        ...
        throw new Error('Error al generar código de estudiante');
    }
};
...
export const generarCodigoEmpleado = async () => {
    try {
        ...
        throw new Error('Error al generar código de empleado');
    }
};
...
export const generarCodigoPadre = async () => {
    try {
        ...
        throw new Error('Error al generar código de padre');
    }
};
