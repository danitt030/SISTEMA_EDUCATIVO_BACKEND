...
export const registrarCalificacionValidator = [
    ...
    body("materia").notEmpty().withMessage("La materia es requerida")
        .isMongoId().withMessage("ID de materia no válido")
    ...
    body("cicloEscolar").notEmpty().withMessage("El ciclo escolar es requerido")
        .isInt({ min: 2020, max: 2100 }).withMessage("Ciclo escolar no válido"),
...
export const obtenerCalificacionPorIdValidator = [
    validateJWT,
    param("id").isMongoId().withMessage("ID de calificación no válido")
...
export const obtenerCalificacionesPorEstudianteValidator = [
    ...
    param("ciclo").isInt({ min: 2020, max: 2100 }).withMessage("Ciclo escolar no válido"),
    validateField,
    handleErrors
];
...
export const obtenerCuadroNotasValidator = [
    ...
    param("cursoId").isMongoId().withMessage("ID de curso no válido")
        .custom(cursoExists),
    param("materiaId").isMongoId().withMessage("ID de materia no válido")
        .custom(materiaExists),
